...
- **A** — главная арка протагониста или franchise engine. Максимум экранного времени, высшие ставки.
- **B** — вторичные линии. Character-led, несут тему, 1–2 сцены на акт.
- **C** — малые нити. Минимум экранного времени, часто comic relief или seed для будущих арок.
- **runner** — неполная Story DNA, нет obstacle/resolution.

### Количество линий по рангу для каждого типа

| тип | A | B | C |
|-----|---|---|---|
| procedural | ровно 1 (franchise engine) | 1–2 | 0–1 |
| hybrid | ровно 1 (franchise engine) | 1–2 serialized | 0–1 |
| serial | ровно 1 (арка протагониста) | 1–4 | 0–2 |
| ensemble | 2–4 (равновесные лиды) | 0–2 | 0–2 |

Для serial: A-линия принадлежит протагонисту. Все остальные линии — какими бы важными они ни были — это B или C. Линия антагониста (напр. Gus в Breaking Bad S04) — это B, не A, потому что экранное время и нарративный фокус по-прежнему на протагонисте.

Для ensemble: несколько A-линий ожидаемы, потому что ни один персонаж не доминирует по экранному времени.

Если хочется присвоить A больше чем одной линии в serial — спроси: чья цель движет БОЛЬШИНСТВОМ сцен? Эта линия = A. Остальные = B.

Таблица рангов выше — про РАСПРЕДЕЛЕНИЕ рангов, не про общее количество линий. Не удаляй валидные линии ради таблицы — если у персонажа есть цель, препятствие и ставки через сезон, это линия, независимо от того сколько слотов B или C тебе кажется доступными.
...
- Serial: 4–8 сквозных линий на сезон.
