...
Имя = абстрактное слово по ЦЕЛИ, не по событию. Ensemble: всегда `Driver: Theme` (напр. "Jon: Honor", "Cersei: Power"). Остальные: добавляй driver когда один персонаж ведёт несколько линий.
